...
def train(
    ...
    ## cunstom
    # disregard model.yaml

    #model_instance = Model(model_config, verbose=True)
    model_instance = EfficientNet.from_pretrained('efficientnet-b0', num_classes=6)
    ...
    ## cunstom
    # optimizer SGD -> AdamW, criterion custom -> CrossEntropyLoss
    ...
    optimizer = torch.optim.AdamW(
        ...
        model_instance.parameters(), lr=data_config["INIT_LR"]
    )
