...
class MobileNetV3(nn.Module):
    def __init__(self, cfgs, mode, num_classes=6, width_mult=1.):
...
class MobileNetV3Generator(GeneratorAbstract):
    ...
    def out_channel(self) -> int:
        ...
        output_channel = {'large': 1280, 'small': 1024}
        width_mult = 1.
        #return make_divisible(output_channel[self.mode] * width_mult, 8) if width_mult > 1.0 else output_channel[self.mode]
        return 6
    ...
    def __call__(self, repeat: int = 1):
        ...
        module = MobileNetV3(cfgs, mode=self.mode)
