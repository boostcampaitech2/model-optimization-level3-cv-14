...
def _mobilenet_v3_model(
    ...
    **kwargs: Any
    ...
    model = MobileNetV3(inverted_residual_setting, last_channel, num_channels=1000, **kwargs)
    if pretrained:
...
class MobileNetV3SmallGenerator(GeneratorAbstract):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        inverted_residual_setting, self.last_channel = _mobilenet_v3_conf(self.arch, kwargs)
        self.module = _mobilenet_v3_model(self.arch, inverted_residual_setting, self.last_channel, pretrained=False, progress=False, **kwargs)
